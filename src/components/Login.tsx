...
import { handleGoogleSignIn } from "../utils/auth/googleSignIn";
...
export function Login() {
  ...
  async function handleLogin(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await signIn(data.token, data.user);
      const redirect =
        data?.homePath || data?.user?.homePath || getHomePath(data.user);
      ...
      <div style={styles.formSection}>
        <div style={styles.formContainer}>
          ...
          <Link
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.style.color = SAFARITIX.primary)
            }
          ...
          {error && (
            <Alert
              style={{
                marginBottom: emailNotVerified ? "8px" : "20px",
                background: "#FEF2F2",
                border: `2px solid ${SAFARITIX.danger}30`,
                borderRadius: "12px",
                padding: "14px 16px",
              }}
            >
            ...
            >
              {resendSent ? (
                <span style={{ color: SAFARITIX.success }}>
                  ...
                  <strong>{emailNotVerified}</strong>
                </span>
              ) : (
                <>
          ...
          {successMessage && (
            <Alert
              style={{
                marginBottom: "20px",
                background: "#F0FDF4",
                border: `2px solid ${SAFARITIX.success}30`,
                borderRadius: "12px",
                padding: "14px 16px",
              }}
            >
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={styles.formGroup}>
              ...
              <div style={styles.passwordWrapper}>
                ...
                <button
                  ...
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = SAFARITIX.neutral)
                  }
                  onMouseLeave={(e) =>
            ...
            <div style={styles.rememberForgot}>
              ...
              <Link
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.color = SAFARITIX.primaryDark)
                }
                onMouseLeave={(e) =>
                  (e.currentTarget.style.color = SAFARITIX.primary)
                }
      ...
      >
        ...
        <div style={styles.brandContent}>
          ...
          <p style={styles.brandSubheading}>
            Experience seamless bus ticketing with real-time tracking, instant
            bookings, and secure payments — all in one platform.
          </p>
